...
nfiles=[gdf.get(dirsrc+"ice.dev.nc"), gdf.get(dirsrc+"ice.ec.nc")]
...
varname=aice_h
var=nds[varname].isel(ni=ipt,nj=jpt,time=slice(lmin,lmax))

axs[ii].set_title(varname1)
axs[ii].plot(tvals, var(case=0))
axs[ii].plot(tvals, var(case=1))
